...
class ArtworkRepairWorker(
    ...
    override suspend fun doWork(): androidx.work.ListenableWorker.Result {
        ...
        // val provider = Provider.findByName(providerName) ?: return androidx.work.ListenableWorker.Result.success()
        ...
        return try {
            ...
            Log.w("ArtworkRepairWorker", "Unable to repair artwork", error)
