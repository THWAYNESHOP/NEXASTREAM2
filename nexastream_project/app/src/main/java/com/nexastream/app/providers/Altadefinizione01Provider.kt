...
object Altadefinizione01Provider : Provider {
    ...
    override suspend fun getTvShow(id: String): TvShow {
        ...
        val tmdbMovie = tmdbTvShow // For consistency with field usage if needed, but better use tmdbTvShow
    ...
    override suspend fun getEpisodesBySeason(seasonId: String): List<Episode> {
        ...
        val episodes = seasonPane?.select("ul > li > a[allowfullscreen][data-link]")?.map { ep ->
            ...
            val episodeMirrors = ep.parent()?.select(".mirrors a[data-link]")?.filter { link ->
    ...
    override suspend fun getGenre(id: String, page: Int): Genre {
        ...
        val shows = doc.select("#dle-content .boxgrid.caption")
            .mapNotNull { el -> parseGridItem(el) as? com.nexastream.app.models.Show }
