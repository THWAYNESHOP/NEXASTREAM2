...
import com.nexastream.app.databinding.FragmentMovieTvBinding
...
class MovieTvFragment : Fragment() {
                ...
                when (state) {
                    ...
                    is MovieViewModel.State.FailedLoading -> {
                        ...
                        binding.isLoading.apply {
                            ...
                            btnIsLoadingRetry.setOnClickListener { viewModel.getMovie() }
    ...
    private fun displayMovie(movie: Movie) {
        ...
        appAdapter.submitList(listOfNotNull(
            ...
            movie.takeIf { it.directors.isNotEmpty() }?.copy()?.apply { itemType = AppAdapter.Type.MOVIE_DIRECTORS_TV },
            movie.takeIf { it.cast.isNotEmpty() }?.copy()?.apply { itemType = AppAdapter.Type.MOVIE_CAST_TV },
            movie.takeIf { it.recommendations.isNotEmpty() }?.copy()?.apply { itemType = AppAdapter.Type.MOVIE_RECOMMENDATIONS_TV },
        ))
    }
}
