...
import com.nexastream.app.models.Video.Server
...
object MStreamProvider : Provider {
    ...
    override suspend fun search(query: String, page: Int): List<AppAdapter.Item> {
        var genres = listOf(
            "Drama", "Action", "Animation", "Abenteuer", "Familie", "Fantasy", "Komödie", "Thriller", "Krimi", "Mystery", "Horror", "Liebesfilm", "Historie", "Kriegsfilm", "Western", "Musik", "Dokumentarfilm", "Action & Adventure", "Sci-Fi & Fantasy", "Soap", "Kids", "Anime", "Science Fiction"
        )
