                        ...
                        for (line in lines) {
                            ...
                            if (patchedLine.startsWith("#EXT-X-MEDIA:TYPE=AUDIO")) {
                                ...
                                val isRightLanguage = trackLang.contains(langCode, ignoreCase = true) || 
                                                      ...
                                                      (langCode == "it" && (trackName.contains("Italian", ignoreCase = true) || trackLang.contains("ita", ignoreCase = true))) ||
                                                      ...
                                                      (langCode == "en" && (trackName.contains("English", ignoreCase = true) || trackLang.contains("eng", ignoreCase = true)))
