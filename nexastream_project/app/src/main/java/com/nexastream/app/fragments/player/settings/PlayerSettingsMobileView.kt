...
import com.nexastream.app.databinding.ItemSettingMobileBinding
        ...
        fun displaySettings(item: Item) {
            binding.root.apply {
                ...
                setOnClickListener {
                    when (item) {
                        ...
                        is Settings.Subtitle.Offset.OffsetItem -> {
                        ...
                        is Settings.Gestures -> {
                            when (item) {
                                ...
                                is Settings.Gestures.Off -> com.nexastream.app.utils.UserPreferences.playerGestures = false
                            }
                            settingsView.displaySettings(Setting.MAIN)
                        }
                        ...
                        is Settings.KeepScreenOn -> {
                            when (item) {
                                is Settings.KeepScreenOn.On -> com.nexastream.app.utils.UserPreferences.keepScreenOnWhenPaused = true
                                is Settings.KeepScreenOn.Off -> com.nexastream.app.utils.UserPreferences.keepScreenOnWhenPaused = false
                            }
                            settingsView.displaySettings(Setting.MAIN)
                        }
            ...
            binding.tvSettingMainText.apply {
                text = when (item) {
                    ...
                    is Settings.Subtitle.Offset.OffsetItem -> context.getString(R.string.player_settings_subtitle_offset_value, item.value / 1000f)
            ...
            binding.tvSettingSubText.apply {
                text = when (item) {
                    ...
                    Settings.Subtitle.Offset -> context.getString(R.string.player_settings_subtitle_offset_value, Settings.Subtitle.Offset.selected.value / 1000f)
                    else -> ""
                }
                visibility = when {
            ...
            binding.ivSettingIsSelected.apply {
                visibility = when (item) {
                    is Settings.Subtitle.Offset.OffsetItem -> when {
                        item.value == Settings.Subtitle.Offset.selected.value -> View.VISIBLE
                        else -> View.GONE
                    }
