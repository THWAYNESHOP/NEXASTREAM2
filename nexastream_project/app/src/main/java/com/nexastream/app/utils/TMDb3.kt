    ...
    private interface ApiService {
        ...
        companion object {
            fun build(): ApiService {
                var apiKey = UserPreferences.tmdbApiKey.ifEmpty { BuildConfig.TMDB_API_KEY }
                
                if (apiKey.isBlank() || apiKey == "your_tmdb_api_key_here") {
                    Log.w("TMDb3", "TMDB API key is missing or placeholder! Using public fallback key.")
                    apiKey = "c63c538c7ac3256ef3fd2f3a3fb352aa"
                }
