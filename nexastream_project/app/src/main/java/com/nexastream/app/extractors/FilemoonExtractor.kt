...
open class FilemoonExtractor : Extractor() {
    ...
    override suspend fun extract(link: String): Video {
        ...
        Log.i("NexaStream", "[Filemoon] Extraction started for: $link")

        // 1. Details
        val detailsUrl = "$currentDomain/api/videos/$videoId/embed/details"
        Log.i("NexaStream", "[Filemoon] Details Request: $detailsUrl")
        ...
        Log.i("NexaStream", "[Filemoon] Playback Domain detected: $playbackDomain")

        // 2. Challenge
        val challengeUrl = "$playbackDomain/api/videos/access/challenge"
        Log.i("NexaStream", "[Filemoon] Challenge Request: $challengeUrl")
        ...
        Log.i("NexaStream", "[Filemoon] Challenge Data: ID=$challengeId, Viewer=$viewerId")

        // 3. Attestation
        val attestation = generateAttestation(nonce)
        val attestUrl = "$playbackDomain/api/videos/access/attest"
        Log.i("NexaStream", "[Filemoon] Attest Request: $attestUrl")
        ...
        Log.i("NexaStream", "[Filemoon] Attest Token obtained (Confidence: $confidence)")

        // 4. Playback
        val playbackUrl = "$playbackDomain/api/videos/$videoId/embed/playback"
        Log.i("NexaStream", "[Filemoon] Playback Request: $playbackUrl")
        ...
        Log.i("NexaStream", "[Filemoon] Decrypting data...")
        ...
        Log.i("NexaStream", "[Filemoon] SOURCE FOUND: $sourceUrl")
